...
\begin{figure}[h!]
	...
	\begin{tabular}{cc}
		...
		\includegraphics[width=0.35\textwidth]{./figures/autocov/plt_autocov_risk_conso_design_N=150_lambda=100_s=0.2_t=0.3.png} & \includegraphics[width=0.35\textwidth]{./figures/autocov/plt_autocov_risk_conso_design_N=150_lambda=100_s=0.5_t=0.2.png}\\
		\color{magenta}[TBC: $(h_1^*(s|t), h_1^*(t|s))$]\color{black} & \color{magenta}[TBC: $(h_1^*(s|t), h_1^*(t|s))$]\color{black} \\
		& \\
		& \\
		$(s, t)= (0.1, 0.4)$ & $(s, t)= (0.8, 0.5)$\\
		\color{magenta}[TBC: $(H_s, H_t)$]\color{black} & \color{magenta}[TBC: $(H_s, H_t)$]\color{black}\\
		\includegraphics[width=0.35\textwidth]{./figures/autocov/plt_autocov_risk_conso_design_N=150_lambda=100_s=0.1_t=0.4.png} &
		\includegraphics[width=0.35\textwidth]{./figures/autocov/plt_autocov_risk_conso_design_N=150_lambda=100_s=0.8_t=0.5.png}\\
		\color{magenta}[TBC: $(h_1^*(s|t), h_1^*(t|s))$]\color{black} & \color{magenta}[TBC: $(h_1^*(s|t), h_1^*(t|s))$]\color{black}
	\end{tabular}
...
\begin{figure}[h!]
	...
	\begin{tabular}{cc}
		$(s, t)= (0.2, 0.3)$ & $(s, t)= (0.5, 0.2)$\\
		\color{magenta}[TBC: $(H_s, H_t)$]\color{black} & \color{magenta}[TBC: $(H_s, H_t)$]\color{black}\\
		\includegraphics[width=0.35\textwidth]{./figures/cov/plt_cov_risk_conso_design_N=150_lambda=100_s=0.2_t=0.3.png} & \includegraphics[width=0.35\textwidth]{./figures/cov/plt_cov_risk_conso_design_N=150_lambda=100_s=0.5_t=0.2.png}\\
		\color{magenta}[TBC: $(h_0^*(s|t), h_0^*(t|s))$]\color{black} & \color{magenta}[TBC: $(h_0^*(s|t), h_0^*(t|s))$]\color{black} \\
		& \\
		& \\
		$(s, t)= (0.1, 0.4)$ & $(s, t)= (0.8, 0.5)$\\
		\color{magenta}[TBC: $(H_s, H_t)$]\color{black} & \color{magenta}[TBC: $(H_s, H_t)$]\color{black}\\
		\includegraphics[width=0.35\textwidth]{./figures/cov/plt_cov_risk_conso_design_N=150_lambda=100_s=0.1_t=0.4.png} &
		\includegraphics[width=0.35\textwidth]{./figures/cov/plt_cov_risk_conso_design_N=150_lambda=100_s=0.8_t=0.5.png}\\
		\color{magenta}[TBC: $(h_0^*(s|t), h_0^*(t|s))$]\color{black} & \color{magenta}[TBC: $(h_0^*(s|t), h_0^*(t|s))$]\color{black}
	\end{tabular}
