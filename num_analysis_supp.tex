...
\begin{figure}[h!]
	...
	\begin{tabular}{cc}
		...
		\includegraphics[width=0.35\textwidth]{./figures/autocov/plt_autocov_risk_conso_design_N=150_lambda=100_s=0.2_t=0.4.png} & \includegraphics[width=0.35\textwidth]{./figures/autocov/plt_autocov_risk_conso_design_N=150_lambda=100_s=0.4_t=0.7.png}\\
...
\begin{figure}[h!]
	...
	\begin{tabular}{cc}
		\color{magenta}$(s, t)= (0.2, 0.4)$\color{black} & \color{magenta}$(s, t)= (0.4, 0.7)$\color{black}\\
		\includegraphics[width=0.35\textwidth]{./figures/cov/plt_cov_risk_conso_design_N=150_lambda=100_s=0.2_t=0.4.png} & \includegraphics[width=0.35\textwidth]{./figures/cov/plt_cov_risk_conso_design_N=150_lambda=100_s=0.4_t=0.7.png}\\
		\color{magenta}$(H_s, H_t) = (0.48, 0.56)$\color{black} & \color{magenta}$(H_s, H_t) = (0.56, 0.68)$\color{black}\\
