...
\color{magenta}
[TBC: lag-0 error-ratio results and the accompanying boxplot figure. The source compares the covariance estimator against its own single-bandwidth version rather than against \texttt{MPV25}. Requires 21\_simulation\_cov.R then 31\_figures\_cov.R; data-simulation/estimates/ has no cov/ directory]
\color{black}
